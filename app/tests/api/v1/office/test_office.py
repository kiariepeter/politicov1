...
class OfficeTests(OfficeTest):
    ...
    def test_office_party(self):
        ...
        response = self.client().post('/api/v1/offices', data=self.add_office, content_type='application/json')
    ...
    def test_get_a_specific_office(self):
        ...
        create_response = self.client().post('/api/v1/offices', data=self.add_office,
